                ...
                <div class="col-md-4 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        ...
                                        <div class="" style="border-bottom:1px solid #fff"><h2 class="text-right px-3 pb-3">0{{$users}}</h2></div>
                            ...
                            <div class="col-md-4 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        ...
                                        <div class="" style="border-bottom:1px solid #fff"><h2 class="text-right px-3 pb-3">0{{$incomeCate}}</h2></div>
                            ...
                            <div class="col-md-4 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        ...
                                        <div class="" style="border-bottom:1px solid #fff"><h2 class="text-right px-3 pb-3">0{{$expenceCate}}</h2></div>
