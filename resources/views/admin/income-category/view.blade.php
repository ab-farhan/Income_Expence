        ...
        <div class="card">
            <div class="card-body pb-5">
                <div class="row card_body_top clearfix">
                    <div class="col-md-7 "><h4><i class="fa fa-gg-circle"></i> View Income Cetagory Information</h4></div>
                    <div class="col-md-5 text-right">
                        <a href="{{url('admin/income/category')}}" class=" card_header_btn"> <i class="fa fa-th"></i> All Income Cetagory</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8 offset-md-2 ">
                        <table class="table table-striped table-bordered custom_table">
                            <tr>
                                ...
                                <td>{{$view->income_cretegory_name}}</td>
                            </tr>
                            <tr>
                                <td>Expence Cetagory Remark</td>
                                <td class="text-center">:</td>
                                <td>{{$view->income_cretegory_remark}}</td>
                            </tr>  
                            <tr>
                                <td>Creted at</td>
                                <td class="text-center">:</td>
