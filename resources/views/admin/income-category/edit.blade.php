    ...
    <div class="col-12 mt-5">
        ...
        <div class="card">
            <div class="card-body ">
                ...
                <div class="contain">
                    <form action="{{url('admin/income/category/edit/submit')}}" method="post" enctype= multipart/form-data>
                    @csrf
                        <div class="row ">
                        ...
                        <div class="input-group input-group-icon{{$errors->has('name') ? ' has_error':''}}"> 
                            <input type="hidden"  name="id" value="{{$edit->income_cretegory_id}}">
                            <input type="text" placeholder="Expence Category Name" name="name" value="{{$edit->income_cretegory_name}}">
                        ...
                        <div class="input-group input-group-icon ">
                            <input type="text" placeholder="Expence Category Remark" name="remark" value="{{$edit->income_cretegory_remark}}">
